...
export const translations: Record<Lang, Translation> = {
  de: {
    ...
    audit: {
      ...
      visibilityKnown: 'Unsere KI kennt {firma}',
      visibilityUnknown: 'Unsere KI kennt {firma} nicht',
      visibilityCaption:
        'Basiert auf KI-Trainingsdaten — ein Indikator für Ihre KI-Sichtbarkeit, kein Live-Check von ChatGPT oder Perplexity.',
  ...
  en: {
    ...
    audit: {
      ...
      visibilityKnown: 'Our AI knows {firma}',
      visibilityUnknown: "Our AI doesn't know {firma}",
      visibilityCaption:
        "Based on AI training data — an indicator of your AI visibility, not a live check of ChatGPT or Perplexity.",
  ...
  fr: {
    ...
    audit: {
      ...
      visibilityKnown: 'Notre IA connaît {firma}',
      visibilityUnknown: 'Notre IA ne connaît pas {firma}',
      visibilityCaption:
        "Basé sur des données d'entraînement IA — un indicateur de votre visibilité IA, pas une vérification en direct de ChatGPT ou Perplexity.",
  ...
  it: {
    ...
    audit: {
      ...
      visibilityKnown: 'La nostra IA conosce {firma}',
      visibilityUnknown: 'La nostra IA non conosce {firma}',
      visibilityCaption:
        'Basato su dati di addestramento IA — un indicatore della tua visibilità IA, non una verifica in tempo reale di ChatGPT o Perplexity.',
